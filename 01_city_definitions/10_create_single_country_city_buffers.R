...
# Validation -------------------------------------------------------------------
    if (!file.exists(input_path)) {
        stop("City definitions file not found at `", input_path, "`.")
    }
...
# Export data to Excel/CSV -----------------------------------------------------
    ...
    message(target_country_name, " city buffers written to: ", output_path)
    message("Number of ", target_country_name, " city buffers created: ", nrow(city_buffers_with_geojson))
